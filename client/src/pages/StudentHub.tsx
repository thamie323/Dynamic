...
import { ChevronRight, FileText, Users, BookOpen, Award, CheckCircle, Briefcase } from "lucide-react";
                ...
                <Card className="bg-muted">
                  <CardContent className="p-6">
                    <div className="mb-4">
                      ...
                      <h4 className="font-bold text-lg mb-1 text-center">Thabo Mokoena</h4>
                      <p className="text-sm text-primary text-center">Software Development Learnership</p>
                    </div>
                    <p className="text-sm italic mb-4">
                      "DNAcademy gave me the skills and confidence to land my dream job as a junior developer. The hands-on training and real-world projects were invaluable. I went from unemployment to earning a competitive salary in just 12 months!"
                    </p>
                    <div className="pt-4 border-t">
                      <p className="text-sm font-semibold text-center">Now working at a leading fintech company</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-muted">
                  <CardContent className="p-6">
                    <div className="mb-4">
                      ...
                      <h4 className="font-bold text-lg mb-1 text-center">Nomsa Dlamini</h4>
                      <p className="text-sm text-primary text-center">Data Science Course</p>
                    </div>
                    <p className="text-sm italic mb-4">
                      "The instructors were amazing and the curriculum was exactly what employers are looking for. I got a job offer before graduation! The support I received helped me transition from retail to tech seamlessly."
                    </p>
                    <div className="pt-4 border-t">
                      <p className="text-sm font-semibold text-center">Data Analyst at major retail corporation</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-muted">
                  <CardContent className="p-6">
                    <div className="mb-4">
                      ...
                      <h4 className="font-bold text-lg mb-1 text-center">Sipho Ndlovu</h4>
                      <p className="text-sm text-primary text-center">Cybersecurity Learnership</p>
                    </div>
                    <p className="text-sm italic mb-4">
                      "Coming from a non-tech background, I was nervous. But the support I received helped me excel and change my career completely. The practical labs and industry certifications opened doors I never thought possible."
                    </p>
                    <div className="pt-4 border-t">
                      <p className="text-sm font-semibold text-center">Security Analyst at international firm</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-muted">
                  <CardContent className="p-6">
                    <div className="mb-4">
                      ...
                      <h4 className="font-bold text-lg mb-1 text-center">Lerato Mahlangu</h4>
                      <p className="text-sm text-primary text-center">Web Development Course</p>
                    </div>
                    <p className="text-sm italic mb-4">
                      "DNAcademy changed my life! I'm now a freelance web developer earning more than I ever did in my previous career. The portfolio projects I built during training helped me land my first clients immediately."
                    </p>
                    <div className="pt-4 border-t">
                      <p className="text-sm font-semibold text-center">Successful freelance developer</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-muted">
                  <CardContent className="p-6">
                    <div className="mb-4">
                      ...
                      <h4 className="font-bold text-lg mb-1 text-center">Zanele Khumalo</h4>
                      <p className="text-sm text-primary text-center">Cloud Computing Learnership</p>
                    </div>
                    <p className="text-sm italic mb-4">
                      "As a single mother, I needed flexible training that fit my schedule. DNAcademy provided that and so much more. I'm now a cloud engineer with a stable career and bright future for my family."
                    </p>
                    <div className="pt-4 border-t">
                      <p className="text-sm font-semibold text-center">Cloud Engineer at tech startup</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-muted">
                  <CardContent className="p-6">
                    <div className="mb-4">
                      ...
                      <h4 className="font-bold text-lg mb-1 text-center">Bongani Sithole</h4>
                      <p className="text-sm text-primary text-center">Network Engineering Course</p>
                    </div>
                    <p className="text-sm italic mb-4">
                      "The hands-on approach and industry certifications made all the difference. I passed my CCNA on the first try and got hired within weeks of graduation. Best investment I ever made in myself!"
                    </p>
                    <div className="pt-4 border-t">
                      <p className="text-sm font-semibold text-center">Network Administrator at ISP</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 py-20 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Student Hub</h1>
